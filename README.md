...
- 우리가 앞으로 공부할 Java, 어떤 언어인지 더 뜯어보고 **객체지향**에 대해 공부해보는 시간을 가질 예정입니다.
...
1. 아래의 정보를 가지는 ‘Bus’ 클래스 모델링
    - 포함해야 할 정보
        1. 최대 승객수 (maxPassengers)
        2. 현재 승객수 (currentOfPassengers)
        3. 요금 (costs)
        4. 버스 번호 (vehicleNumber)
        5. 주유량 (amountOfFuel)
        6. 현재 속도 (speed)
        7. 상태
            1.  운행, 차고지 행
...
[Spring 과제 가이드라인 및 시나리오](https://www.notion.so/Spring-0ec5b8b6302b4589850a2d6ed85e4569)
